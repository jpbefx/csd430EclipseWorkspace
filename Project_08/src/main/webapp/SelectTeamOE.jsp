...
<html>
    <head>
        ...
        <title>Select Team Table OE</title>
    </head>
    <body>
        <h1>Select Team Table OE</h1>
          ...
          <%
              ...
              if(request.getMethod().equals("POST")){
                  ...
                  try{
                      ...
                      resultSet = stmt.executeQuery("SELECT * FROM Wins_WK_06_OE WHERE Team = '" + team + "' OR LoserTeam = '" + team + "'");
                  }
    ...
    %>
        <form method='post' action='SelectTeamOE.jsp'>
