...
<html>
    <head>
        ...
        <title>Select Team Bean OE</title>
    </head>
    <body>
        <h1>Select Team Bean OE</h1>
        <div>
            ...
            <jsp:useBean id='myDB' class='dbBeans.MyDatabaseBeanOE' />
            ...
            <%
                ...
                resultSet = myDB.getResults("SELECT * FROM Wins_WK_07_OE WHERE Team = '" + team + "' OR LoserTeam = '" + team + "'");
...
//--------------------------------------------------------------------------
                ...
                resultSet = myDB.getResults("SELECT * FROM Wins_WK_07_OE");
            ...
            <form method='post' action='SelectTeamBeanOE.jsp'>
